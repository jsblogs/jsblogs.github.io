...
description: This tutorial is an addition over my spring-security with angular JS video tutorial and will be focusing on the JWT token part.
pubDatetime: "2020-08-23T00:00:00-04:00"
tags:
  - java
  - springboot
  - spring-security
  ...
  - jwt
  - spring
ogImage: /images/spring/spring-security-logo.png
---
...
This blog post will demonstrate the spring-security & angular JS integration using JWT token. My previous blog explains how we can configure classes to integrate 
 spring security with angular. I recommend you to watch my video tutorial on [Spring Security Using OAuth2 with Angular JS](/blog/spring-security-using-oauth2-with-angular-js)
...
![OAuth2Flow](/images/spring/OAuthFlow.png)
