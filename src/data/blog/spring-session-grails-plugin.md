...
description: "Part 1 of \"Spring Session Grails Plugin\" series. This blog series will cover Introduction, Installation and Redis Datastore."
pubDatetime: "2016-12-15T00:00:00-04:00"
tags:
  - grails
  - java
  - spring-session
...
Json serialization will work perfectly until your class has default constructor. But if any class doesn't have default constructor then you'll need
  ...
  json with Java parameterized constructor](/blog/deserialize-json-with-java-parameterized-constructor).
...
In [next post](/blog/spring-session-grails-plugin-part-2)
