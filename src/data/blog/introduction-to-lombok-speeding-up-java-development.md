...
description: This blog post will cover Project Lombok annotations.
...
1. Check your Idea build number. Go to __Help__ -> __About__
    ...
    ![About](/images/java/lombok/about.png)
...
3. Goto __File__ -> __Settings__ -> Type Plugins in search text box at top left.
    ...
    ![Plugin Settings](/images/java/lombok/settings.png)
...
<script src="https://gist.github.com/jeetmp3/fa6d9327b670071f11b417ca9693029f.js"></script>
