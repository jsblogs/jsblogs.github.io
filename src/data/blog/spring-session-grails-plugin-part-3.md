...
description: "Part 3 of \"Spring Session Grails Plugin\" series. This blog series will cover JDBC Data store."
pubDatetime: "2017-03-30T00:00:00-04:00"
tags:
  - grails
  - java
  - spring-session
...
By default it uses Java serialization. To use Json Serialization please visit to [__first blog__](/blog/spring-session-grails-plugin) of this series. First 2 steps will be same but in 3<sup>rd</sup> step __*Register my module class with spring-session plugin*__ you will have to use jdbc specific `jackson.modules` property.
