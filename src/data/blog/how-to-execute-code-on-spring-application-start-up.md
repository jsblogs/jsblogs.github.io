...
description: SpringFramework provides a way to perform some tasks at the time of application/context started.
pubDatetime: "2020-02-25T00:00:00-04:00"
tags:
  - spring
  - context-started
  - java
  - springboot
ogImage: /images/spring/boot-32.png
---
...
1. [Java 11]({{ site.baseurl }}/tags#java)
2. [Spring Boot 2.2.4]({{ site.baseurl }}/tags#springboot)
3. Gradle 6.0.1
